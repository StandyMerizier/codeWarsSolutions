...
function domainType(domains) {
    ...
    for(let i = 0; i < domains.length; i++){
        if(domains[i].substring(domains[i].length - 3) === "com"){
            result.push("commercial")
        }
        else if(domains[i].substring(domains[i].length - 3) === "org"){
            result.push("organization")
        }
        else if(domains[i].substring(domains[i].length - 3) === "net"){
            result.push("network")
        }
        else if(domains[i].substring(domains[i].length - 4) === "info"){
